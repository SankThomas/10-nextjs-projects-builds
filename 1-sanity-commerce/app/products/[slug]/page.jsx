        ...
        <div className="space-y-8">
                ...
                <div className="flex h-[500px] items-center justify-center bg-black/50">
                  <article className="mx-auto max-w-lg space-y-4 text-center">
                    ...
                    {product.publisherName && (
                      <CardTitle>By {product.publisherName}</CardTitle>
                    )}
          ...
          <div>
            <div className="grid gap-8 rounded-lg border border-neutral-800 md:grid-cols-2">
              ...
              <CardContent className="space-y-4 pt-4">
                <CardDescription>
                  Last updated:{" "}
                  {format(new Date(product.publishedAt), "do MMMM yyyy")}
                </CardDescription>
          ...
          !product.publisherImage ? null : (
            <Card className="lg:max-w-3xl">
              <CardHeader>
                <CardTitle className="mb-4">About the publisher</CardTitle>

                {product.publisherImage ? (
                  <div>
                    <Image
                      src={urlFor(product.publisherImage).url()}
                      width={80}
                      height={80}
              ...
              <CardContent>
                ...
                {product.publisherBio && (
                  <div className="portabletext">
                    <PortableText value={product.publisherBio} />
                  </div>
                )}
              </CardContent>
            </Card>
