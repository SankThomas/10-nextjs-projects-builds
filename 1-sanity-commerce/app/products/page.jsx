...
export default async function Products() {
  ...
  return (
    <div className="container mx-auto px-4 py-20">
      <h1 className="mb-8 text-3xl font-bold">Viewing available products</h1>
            ...
            <Card key={product.slug} className="group">
              <CardHeader>
                <Image
                  ...
                  width={1920}
                  height={1080}
                  className="h-[250px] w-full rounded-lg object-cover object-top grayscale transition group-hover:grayscale-0"
                />
              </CardHeader>
